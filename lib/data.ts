...
export const categories: Category[] = [
  {
    ...
    href: "/categories/safety-shoes",
    subgroups: [{ title: "Safety Shoes", items: ["Steel Toe Shoes", "PU Sole Shoes", "Double Density", "Gumboots", "Composite Toe Shoes"] }],
  },
  {
    id: "cat-pvc-gumboots",
    name: "PVC GumBoots",
  ...
  },
  {
    ...
    tileBg: "bg-cat-hivis",
    href: "/categories/reflective-jackets",
    subgroups: [{ title: "Reflective Jackets", items: ["Orange Mesh", "Green Mesh", "Polyester", "Cotton", "Survey Jackets"] }],
  },
  {
    ...
    href: "/categories/safety-helmets",
    subgroups: [{ title: "Safety Helmets", items: ["HDPE Helmets", "Ratchet Type", "Ventilated", "With Chin Strap", "ABS Helmets"] }],
  },
  {
    ...
    subgroups: [{ title: "Safety Gloves", items: ["Leather Gloves", "Latex Coated", "Cut Resistant", "Welding Gloves", "Nitrile Coated"] }],
  },
  {
    id: "cat-welding",
    ...
    productCount: 30,
    image: catImg("1504917595217-d4dc5ebe6122"),
    tileBg: "bg-cat-welding",
    href: "/categories/welding",
    subgroups: [{ title: "Welding", items: ["ARC Machines", "MIG Welders", "Welding Rods", "Helmets & Gloves", "TIG Welders"] }],
  },
  {
  ...
  },
  {
    ...
    subgroups: [{ title: "Face & Ear", items: ["Safety Goggles", "Face Shields", "Ear Muffs", "Ear Plugs", "Respirators"] }],
  },
  {
    id: "cat-road-safety",
    name: "Road Safety",
